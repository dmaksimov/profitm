                            ...
                            <div class="form-row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <v-select :options="industries" label="name" v-model="industrySelected" class="filter--v-select" @input="clearError(campaignForm, 'industry')" :class="{'is-invalid': campaignForm.errors.has('industry')}"></v-select>
                                            ...
                                            <div class="feature-table">
                                                <form v-if="campaignForm.enable_text_to_value">
                                                    <div class="alert alert-info mt-2">
                                                        <i class="fa fa-info-circle mr-2"></i>
                                                        @if($template)
                                                            Available placeholders: <span v-pre>
