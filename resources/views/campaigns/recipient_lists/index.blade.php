...
@section('main-content')
    <div class="container" id="recipients-index" v-cloak>
        <div class="row align-items-end no-gutters mb-3">
            ...
            <div class="col-12 col-sm-5 col-lg-4">
                @if (auth()->user()->isAdmin())
                    ...
                    @else
                        <button dusk="add-recipient-list-button" class="btn pm-btn pm-btn-blue float-right" v-b-modal.create-template >
                            <i class="fas fa-plus mr-2"></i> UPLOAD NEW LIST
                        </button>
                    @endif
                @endif
        ...
        <b-modal ref="createTemplate" id="create-template" size="lg" hide-footer>
            <template slot="modal-header">
                <h4>Note : </h4>
            </template>
            <pre>Please Create Template To Add PM Fields</pre>
            <div class="w-100">
                <button class="btn pm-btn-purple float-right " @click="closeModal('createTemplate')">
                    Close
                </button>
                <a class="btn pm-btn-blue float-right mr-3" href="/industry-template/{{$id}}">
                    Create Template
                </a>
