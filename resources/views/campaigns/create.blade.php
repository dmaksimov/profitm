...
@section('body-script')
    <script>
        ...
        window.getCompaniesByIndustry = @json(route('campaign.getCompaniesByIndustry'));
                ...
                <form-wizard :title="''" :subtitle="''" :step-size="'sm'" :color="'#572E8D'" @on-complete="saveCampaign">
                    ...
                    <tab-content title="Accounts" icon="fas fa-user" :before-change="validateAccountsTab">
                        <div class="form-row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <v-select dusk="industry-select" :options="industries" v-on:change="getSelectedCompany()" label="name" v-model="industrySelected" class="filter--v-select" @input="clearError(campaignForm, 'industry')" class="{'is-invalid': campaignForm.errors.has('industry')}"></v-select>
                                    <input-errors :error-bag="campaignForm.errors" :field="'industry'"></input-errors>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="Dealership">Companies</label>
