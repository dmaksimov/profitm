                    ...
                    <form-wizard :title="''" :subtitle="''" :step-size="'sm'" :color="'#572E8D'" @on-complete="saveCompany">
                        <tab-content title="Description" icon="fas fa-list-ul" :before-change="validateBasicTab">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="type" v-model="createForm.industry_type_id" :class="{ 'form-control': true, 'is-invalid': $v.createForm.industry_type_id.$error }" required>
                                        @foreach ($industries as $industry)
                                        <option value="{{$industry->id}}">{{$industry->name}}</option>
                                        @endforeach
                                    </select>
                                    <div class="text-sm mt-2 ml-2 invalid-feedback" v-if="$v.createForm.industry_type_id.$error">
                                        <div v-if="!$v.createForm.industry_type_id.required">Industry Type is required</div>
                                    </div>                                    
                            </div>
                            <div class="form-group">
                                ...
                                <div class="text-sm mt-2 ml-2 invalid-feedback" v-if="$v.createForm.type.$error">
                                    <div v-if="!$v.createForm.type.required">Type is required</div>
                                </div>
                            </div>
                        </tab-content>
