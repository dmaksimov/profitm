<div class="top-navbar" id="top-navbar-menu" v-cloak>
    <b-navbar toggleable="sm" class="top-navigation-bar justify-content-space-between justify-content-sm-start">
        ...
        <b-navbar-nav class="navbar-menu m-0 ml-md-3">
            ...
            @endcan
            @can('list', \App\Models\Campaign::class)
                <b-nav-item href="{{ route('campaigns.fb') }}" active>
                    <i class="fab fa-facebook-square" style="font-size: 0.85rem;margin-bottom: 5px;"></i>
                    <span>Facebook Campaigns</span>
                </b-nav-item>
            @endcan
            @can('list', \App\Models\Campaign::class)
            <b-nav-item href="{{ route('events.index') }}" active>
            ...
            @endif
            @if (auth()->user()->isAdmin())
            <b-nav-item href="{{ route('industry_types.index') }}" active>
