...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/fetch-events', 'EventController@fetch')->name('events.fetch');
    ...
    Route::get('/facebook-campaigns', 'CampaignController@getFbCampaigns')->name('campaigns.fb')->middleware('can:view-campaigns');
    Route::match(['get','post'],'/add-appointment/{id}/{cid?}', 'FbAppointmentController@create')->name('fb.appointment.create')->middleware('can:view-campaigns');
    Route::get('/view-appointments/{id}', 'FbAppointmentController@index')->name('fb.appointment.index')->middleware('can:view-campaigns');
    Route::get('/view-recipients/{id}', 'CustomerController@index')->name('fb.recipients.index')->middleware('can:view-campaigns');
    Route::get('/edit-recipients/{id}', 'CustomerController@edit')->name('fb.recipients.edit')->middleware('can:view-campaigns');
    Route::get('/edit-appointments/{id}', 'FbAppointmentController@edit')->name('fb.appointment.edit')->middleware('can:view-campaigns');
    Route::get('/fetch-campaigns', 'CampaignController@fetchCampaigns')->name('campaigns.fetch');
    Route::get('/get-campaign/{id}', 'CampaignController@getCampaign')->name('campaigns.get');
    Route::get('/fetch-customers/{id}', 'CustomerController@fetchCustomers')->name('customers.fetch');
    Route::get('/fetch-customer/{id}', 'CustomerController@fetchCustomer')->name('customer.fetch');
    Route::match(['post','get'],'/create-recipients/{id}', 'CustomerController@create')->name('customer.create');
    Route::post('/update-customer/{id}', 'CustomerController@update')->name('customer.update');
    Route::post('/update-status', 'FbAppointmentController@update')->name('appointment.update');
    Route::get('/assign-companies/{id}', 'CampaignController@assignCompanies')->name('assign.companies');
    Route::post('/assign-companies/{id}', 'CampaignController@updateCompanies')->name('assign.post');
    Route::get('/fetch-appointments/{id}', 'FbAppointmentController@fetchAppointments')->name('appointments.fetch');
    Route::get('/campaigns/for-user-display', 'CampaignController@getForUserDisplay')->name('campaign.for-user-display');
    Route::get('/campaigns/getCompaniesByIndustry', 'CampaignController@getCompaniesByIndustry')->name('campaign.getCompaniesByIndustry');
    ...
    Route::match(['post','get'],'/industry-template/{id}', 'IndustryTypeController@template');
    ...
    //region INDUSTRY TYPE
        //  Route::get('/{id}', 'IndustryTypeController@details')->name('industry_types.details');

         Route::get('for-industry_type-display', 'IndustryTypeController@getForIndustryTypeDisplay')->name('industry_types.for-industry_type-display');
         Route::post('/update-industrytype/{id}', 'IndustryTypeController@update')->name('industrytype.update');

        Route::resource('industry_types', 'IndustryTypeController');
    //endregion
